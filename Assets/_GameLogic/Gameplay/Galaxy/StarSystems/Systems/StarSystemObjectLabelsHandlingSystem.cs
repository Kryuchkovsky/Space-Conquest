...
namespace _GameLogic.Gameplay.Galaxy.StarSystems.Systems
{
    ...
    public class StarSystemObjectLabelsHandlingSystem : AbstractSystem
    {
        ...
        {
            _starSystemObjectFilterBuilder = World.Filter
            ...
            foreach (var cameraEntity in _gameCameraFilter.Build())
            {
                if (cameraEntity.GetComponent<Index>().Value == 1)
                {
                    ...
                    foreach (var entity in _starSystemObjectFilterBuilder.Build())
                    {
                        ...
                        {
                            var parent = StarSystemLocalUIContainer.Instance.LabelsContainer;
